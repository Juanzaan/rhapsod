...
const PENALIZED_TERMS = /\b(cover|live|remix|reaction|review|shorts?|sped up|slowed|nightcore|karaoke)\b/i;
const POSITIVE_TERMS = /\b(official audio|official video|topic|provided to youtube)\b/i;
...
export function scoreCandidate(
  ...
  let score = queryTerms.length
    ? (matchingTerms / queryTerms.length) * 45
    : 0;
